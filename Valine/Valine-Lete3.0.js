    ...
    return function (e) {
        ...
        var C = function (e, t) {
            ...
            add: function (e, t) {
                ...
                if (1 === r.length) {
                    var o = r[0], i = decodeURI((0, y.default)(o).attr("id")), a = (0, y.default)(o).attr("data-flag-title"), s = encodeURI(i), l = {
                        el: o,
                        url: i,
                        xid: s,
                        title: a
                    ...
                    r.containedIn("url", n), r.find().then(function (e) {
                        e.length > 0 && t.forEach(function (t) {
                            e.forEach(function (e) {
                                var n = e.get("xid") || encodeURI(e.get("url")), r = e.get("time"), o = (0, y.default)(t), i = o.attr("id");
        ...
        o.prototype.Q = function (e) {
            ...
            var C = function (t, n, r) {
                ...
                var ism = e.config.master.includes((0, s.default)(t.get("mail"))), isf = e.config.friends.includes((0, s.default)(t.get("mail").toLowerCase())), gat = ism ? '<span class="vtag vmaster">' + e.config.tagMeta[0] + '</span>' : isf ? '<span class="vtag vfriend">' + e.config.tagMeta[1] + '</span>' : '<span class="vtag vvisitor">' + e.config.tagMeta[2] + '</span>';
                ...
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "", c = l ? '<a class="vnick" rel="nofollow" href="' + l + '" target="_blank" >' + t.get("nick") + "</a>" + gat : '<span class="vnick">' + t.get("nick") + "</span>" + gat, u = T.hide ? "" : qal ? '<img class="vimg" src="' + qal + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (T.cdn + (0, s.default)(t.get("mail")) + T.params) + '">', d = u + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span style="color: red;" class="vtime" >' + (0, g.default)(t.get("insertedAt"), e.i18n) + '</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, S.default)(t.get("comment")) + '</div><div class="vreply-wrapper" data-self-id="' + t.id + '"></div><div class="vquote" data-self-id="' + t.id + '"></div></div>';
                o.html(d);
                var p = o.find(".vat");
        ...
        var r;
        if (!Object.keys) {
            var o = Object.prototype.hasOwnProperty, i = Object.prototype.toString, a = n(10), s = Object.prototype.propertyIsEnumerable, l = !s.call({toString: null}, "toString"), c = s.call(function () {
            }, "prototype"), u = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], d = function (e) {
                var t = e.constructor;
